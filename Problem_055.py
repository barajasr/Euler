...
#
# Although no one has proved it yet, it is thought that some number,
# like 196, never produce a palindrome. A number that never forms
# a palindrome through the reverse and add process is called a
...
# to a palindrome. In fact, 10677 is the first number to be shown to
# require over fifty iterations before producing a palindrome:
# 4668731596684224866951378664 (53 iterations, 28-digit).
#
...
def main():
    print 'How many Lychrel number are there under ten-thousand?'
